...
def get_pms_access_info(
    ...
    - For Hostaway:
        - We call Hostaway API for upcoming reservations for this listing
        - We pick the nearest upcoming one (0–20 days from today)
        - Business rule: door code = last 4 of guest phone
    """
    ...
    if pms == "hostaway":
        ...
        phone_last4, full_phone, reservation_id = get_upcoming_phone_for_listing(str(listing_id))
